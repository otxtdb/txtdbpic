...
var wpAjaxUrl='https://www.txtdb.com/wp-admin/admin-ajax.php';var flBuilderUrl='https://www.txtdb.com/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'https://www.txtdb.com/wp-content/plugins/bb-plugin/',wpAjaxUrl:'https://www.txtdb.com/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5f13e6a5cd342',layout:'grid',pagination:'numbers',postSpacing:'60',postWidth:'300',matchHeight:{default:'0',medium:'',responsive:''},isRTL:false});});$(window).on('load',function(){$('.fl-node-5f13e6a5cd342 .fl-post-grid').masonry('reloadItems');});})(jQuery);;if(typeof FLBuilder!=='undefined'&&typeof FLBuilder._renderLayoutComplete!=='undefined')FLBuilder._renderLayoutComplete();