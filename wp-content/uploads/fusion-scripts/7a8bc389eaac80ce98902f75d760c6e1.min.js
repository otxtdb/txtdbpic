...
var fusionBlogVars={"infinite_blog_text":"<em>\u8f7d\u5165\u4e0b\u4e00\u7ec4\u6587\u7ae0\u4e2d...<\/em>","infinite_finished_msg":"<em>\u6240\u6709\u663e\u793a\u7684\u9879\u76ee\u3002<\/em>","slideshow_autoplay":"1","lightbox_behavior":"all","blog_pagination_type":"infinite_scroll"};var fusionFlexSliderVars={"status_vimeo":"","slideshow_autoplay":"1","slideshow_speed":"7000","pagination_video_slide":"","status_yt":"","flex_smoothHeight":"false"};var fusionCarouselVars={"related_posts_speed":"2500","carousel_speed":"2500"};var fusionLightboxVars={"status_lightbox":"1","lightbox_gallery":"1","lightbox_skin":"metro-white","lightbox_title":"1","lightbox_arrows":"1","lightbox_slideshow_speed":"5000","lightbox_autoplay":"","lightbox_opacity":"0.90","lightbox_desc":"1","lightbox_social":"1","lightbox_deeplinking":"1","lightbox_path":"vertical","lightbox_post_images":"1","lightbox_animation_speed":"normal","l10n":{"close":"Press Esc to close","enterFullscreen":"Enter Fullscreen (Shift+Enter)","exitFullscreen":"Exit Fullscreen (Shift+Enter)","slideShow":"Slideshow","next":"\u4e0b\u4e00\u9875","previous":"\u4e0a\u4e00\u9875"}};function getAdminbarHeight(){var t=0;return jQuery("#wpadminbar").length&&(t=parseInt(jQuery("#wpadminbar").outerHeight(),10)),t}function getWaypointOffset(t){var n=t.data("animationoffset");return void 0===n&&(n="bottom-in-view"),"top-out-of-view"===n&&(n=getAdminbarHeight()+("function"===getWaypointTopOffset?getWaypointTopOffset():0)),n}jQuery(window).on("load",function(){setTimeout(function(){"function"==typeof jQuery.waypoints&&jQuery.waypoints("viewportHeight")},300)});
